    ...
    return [
      {
        ...
        description: 'Join 2 Tournaments to Get Reward',
      ...
      },
      {
        ...
        description: 'Join 6 Tournaments to Get Reward',
        icon: <Target size={24} className="text-gray-400 mr-3" />,
        progress: p_join_6,
        target: 6,
      ...
      },
      {
        id: 'win_3_matches',
        title: 'Win 3 Matches',
        description: 'Win 3 Matches to Get Reward',
    ...
    return [
      {
        ...
        description: 'Join 20 Tournaments in a week to Get Bigger Reward',
          ...
          <div className="space-y-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li className="flex items-start">
                  ...
                  <span>Reset Every Day at Midnight 12 AM</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>Reset Every Sunday at Midnight 12 AM</span>
                </li>
                 <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>Earn Coins for Immediate Use</span>
