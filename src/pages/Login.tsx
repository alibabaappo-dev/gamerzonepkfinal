        ...
        <div className="w-full max-w-[380px] bg-[#151B28]/90 backdrop-blur-xl border border-white/5 rounded-[2rem] p-6 lg:p-8 shadow-2xl">
          <div className="flex justify-center mb-6">
            <div className="flex flex-col items-center justify-center">
              <img src="https://i.ibb.co/JwjG5968/logo.png" alt="Gamer Zone Logo" className="w-23 border border-transparent rounded-sm" />
            </div>
          </div>
          ...
          {forgotPasswordStep === 0 ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button 
                type="submit" 
                disabled={isLoading}
                className="w-full bg-[#1D4ED8] hover:bg-[#1E40AF] text-white font-bold py-3 rounded-xl transition-all shadow-lg text-base disabled:opacity-50 disabled:cursor-not-allowed"
              >
