    ...
    <div className="min-h-screen bg-[#0D0D0D] text-white font-sans relative overflow-x-hidden">
        ...
        <div className="container mx-auto px-4 h-16 flex justify-between items-center">
          <div className="flex items-center">
            <div className="flex items-center justify-center">
              <img src="https://i.ibb.co/JwjG5968/logo.png" alt="Gamer Zone Logo" className="w-11 border border-transparent rounded-sm" />
            </div>
          </div>
      ...
      <section className="relative pt-20 pb-16 px-4 text-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-30">
          <img 
            src="https://i.ibb.co/9jZnn9G/bg.jpg" 
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-yellow-400/10 border border-yellow-400/20 px-4 py-1.5 rounded-full mb-8">
              ...
              <span className="text-xs font-bold text-yellow-400 uppercase tracking-wider">Pakistan's Premier FF Tournament Platform</span>
            </div>
      ...
      <section className="px-4 py-20 text-center bg-[#0D0D0D]">
        ...
        >
          ...
          {[
            ...
            { step: "2", icon: <CreditCard className="text-yellow-400" />, title: "Buy Coins", desc: "Purchase coins via NayaPay , Sadapay , or Bank transfer and 1 COIN = 1 PKR" },
      ...
      <section className="px-4 py-20 text-center">
        ...
        >
          ...
          {['JazzCash', 'EasyPaisa','NayaPay', 'Sadapay','Mezaan','Bank Transfer' ].map((method) => (
        ...
        <div className="bg-[#111827] border border-gray-800 p-10 rounded-[2.5rem] max-w-md mx-auto">
          ...
          <div className="space-y-10">
            {[
              { step: "1", title: "Enter Coins and Select Method", desc: "Enter Coins you want to deposit in your account and Select Payment Method" },
              { step: "2", title: "Send Payment", desc: "Transfer coins amount to our provided account using any supported payment method" },
              { step: "3", title: "Upload Screenshot", desc: "Submit payment proof screenshot through your dashboard for verification" },
              { step: "4", title: "Get Coins Instantly", desc: "Admin verifies and credits coins to your wallet within 24 hours" }
            ].map((item, i) => (
          ...
          <div className="grid grid-cols-2 gap-4 mt-12 pt-8 border-t border-gray-800">
            <div>
              <div className="text-xl font-black text-green-400">1 PKR</div>
      ...
      <section className="px-4 py-20 text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white mb-6 leading-tight">
            Ready to Start Your Winning Journey With Gamer Zone ?
          </h2>
      ...
      <footer className="px-4 py-12 text-center border-t border-gray-900">
        <div className="text-2xl font-black text-yellow-400 mb-2"><p></p> Gamer Zone</div>
