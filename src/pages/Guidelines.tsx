...
export default function Guidelines() {
  ...
  const menuItems = [
    ...
    { id: 'Tournament History', icon: History, label: 'Tournament Result History' },
        ...
        <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="text-sm">
                      ...
                      <span className="text-gray-400 ml-2">Shows your available coins</span>
                    </div>
                  </div>
                  <div className="flex items-start">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm">
                      <span className="text-white font-bold">Total Joined:</span>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm">
                      ...
                      <span className="text-gray-400 ml-2">Show Life-Time Earnings</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="bg-[#0F1521] border border-gray-800/50 rounded-2xl p-5 shadow-xl">
                ...
                <ol className="space-y-3 text-sm text-gray-400">
                  ...
                  <li>4. Upload Payment Proof</li>
                  <li>5. Complete the payment</li>
                  <li>6. Coins will be added within 24 hours</li>
                </ol>
              </div>
              ...
              <div className="bg-[#050B1A] border border-blue-500/20 rounded-2xl p-5 shadow-xl">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <p className="text-center text-white font-bold ">
                    ADMIN CAN CHANGE DEPOSIT AND WITHDRAWAL LIMITS
                  </p>
                </div>
              </div>
          ...
          {activeSection === 'Leaderboard' && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="bg-[#0F1521] border border-gray-800/50 rounded-2xl p-5 shadow-xl">
                <h3 className="text-lg font-bold text-white mb-4">Leaderboard Type</h3>
                <div className="space-y-3">
              ...
              <div className="bg-[#0F1521] border border-gray-800/50 rounded-2xl p-5 shadow-xl">
                ...
                <div className="bg-[#1E293B]/50 p-4 rounded-xl border border-gray-700/50">
                  ...
                  <p className="text-gray-400 text-xs mb-4">If multiple players have the same winnings, the number of won tournaments will be counted. The player with higher won tournaments will be ranked higher.</p>
                  <div className="space-y-1 text-xs">
                    <p className="text-white font-bold">Example:</p>
                    <p className="text-gray-400">Player A: 500 winnings, 10 tournaments wins</p>
                    <p className="text-gray-400">Player B: 500 winnings, 8 tournaments wins</p>
                    <p className="text-green-400 font-bold mt-1">Result: Player A ranks higher</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#052A1C] border border-green-500/20 rounded-2xl p-5 shadow-xl">
                ...
                <div className="space-y-4 text-sm">
                  <div>
                    ...
                    <p className="text-gray-400">Tasks reset every day at midnight 12 AM</p>
                  </div>
                  <div>
              ...
              <div className="bg-[#052A1C] border border-green-500/20 rounded-2xl p-5 shadow-xl">
                ...
                <div className="space-y-4 text-sm">
                  <div>
                    ...
                    <p className="text-gray-400">Tasks reset every week at Sunday at midnight 12 AM</p>
                  </div>
                  <div>
                    <h4 className="text-green-400 font-bold mb-1">One-Time Claims</h4>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="bg-[#0F1521] border border-gray-800/50 rounded-2xl p-5 shadow-xl">
                ...
                <div className="bg-[#050B1A] border border-blue-500/20 p-3 rounded-xl">
                  ...
                  <p className="text-gray-400 text-xs">Up to 48 hours</p>
                </div>
              </div>
  ...
  <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    <div className="space-y-3">
      {[
        ...
        { q: "How to report a cheater?", a: "Make a recording of cheater and contact admin on support create support request or contact support with proof." },
        ...
        <div key={i} className="bg-[#0F1521] border border-gray-800/50 rounded-xl overflow-hidden transition-all duration-300">
          <button 
            onClick={() => setOpenFaqIndex(openFaqIndex === i ? null : i)}
            className="w-full flex items-center justify-between p-4 text-left group"
          >
            <span className={`text-sm font-bold transition-colors ${openFaqIndex === i ? 'text-yellow-400' : 'text-white group-hover:text-yellow-400'}`}>
              {faq.q}
            </span>
            {/* Arrow rotate hoga jab FAQ open hoga */}
            <ChevronRight size={16} className={`text-gray-500 transition-transform duration-300 ${openFaqIndex === i ? 'rotate-90' : ''}`} />
          </button>
          
          {/* Answer sirf tab show hoga jab openFaqIndex current index (i) ke barabar hoga */}
          {openFaqIndex === i && (
            <div className="px-4 pb-4 text-xs text-gray-400 leading-relaxed border-t border-gray-800/50 pt-3 animate-in fade-in slide-in-from-top-2">
              {faq.a}
            </div>
          )}
        </div>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="bg-[#0F1521] border border-gray-800/50 rounded-2xl p-5 shadow-xl">
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  ...
                  <li>• Deposit response time: 24 hours</li>
                  <li>• Withdrawal response time: 24 hours</li>
                  <li>• 1 Day Only 1 withdrawal Next After 24 Hours</li>
