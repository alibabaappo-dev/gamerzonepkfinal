              ...
              if (isJoined) {
                buttonContent = (
                  <button 
                    ...
                    className="w-full bg-green-600 hover:bg-green-500 text-white font-bold py-3 rounded-xl transition-colors shadow-[0_0_15px_rgba(34,197,94,0.3)] text-sm"
                  >
                    Room Details
                  </button>
                );
                ...
                buttonContent = (
                  <button disabled className="w-full bg-red-900/20 border border-red-900/50 text-red-500 font-bold py-3 rounded-xl cursor-not-allowed text-sm">
                    Slots Full
                  </button>
                );
                ...
                buttonContent = (
                  <button disabled className="w-full bg-[#1E293B] text-gray-500 font-bold py-3 rounded-xl cursor-not-allowed text-sm">
                    {message}
                  </button>
                );
                ...
                <div key={tournament.id} className="bg-[#0F172A] border border-gray-800 rounded-3xl p-5 flex flex-col">
                  ...
                  <div className="space-y-2 mb-4 flex-grow">
                    <div className="flex justify-between items-start">
                      <div className="flex items-center text-gray-400 text-sm">
                        <LinkIcon size={14} className="mr-2" /> Entry Fee
                      </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="text-yellow-400 font-bold text-sm">{tournament.prizePool} coins</div>
                    </div>
                  ...
                  <div className="space-y-2 mb-6">
                    ...
                    <div className="flex justify-between items-center text-sm">
                      ...
                      <div className="text-white-400 font-bold">{formatTime12Hour(tournament.startTime || tournament.time)}</div>
                    </div>
                  ...
                  <div className="space-y-3">
                    <Link to={`/tournaments/${tournament.id}`} className="block w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-2.5 rounded-xl text-center transition-colors">
                      View details
                    </Link>
          ...
          <div className={`bg-[#0F172A] border border-gray-800 rounded-2xl w-full ${activeModal.type === 'details' ? 'max-w-[300px] shadow-[0_0_25px_rgba(234,179,8,0.15)]' : 'max-w-md'} overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200`}>
            ...
            {activeModal.type === 'join' ? (
              <div className="p-5 space-y-5 max-h-[80vh] overflow-y-auto">
                ...
                {/* Form */}
                <div>
                  <h4 className="text-white font-bold text-sm mb-3">Enter All Details ( Correct )</h4>
                  <div className="grid grid-cols-2 gap-3 mb-3">
                    ...
                    <div>
                      <label className="block text-[10px] text-gray-400 mb-1">Free Fire UID *</label>
                      <input 
                        type="number" 
                        value={freeFireId}
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  >
                    {isJoining ? (
                      ...
                      `Join Tournament ( ${activeModal.tournament.entryFee} coins - ${activeModal.tournament.entryFee} coins per player )`
                    )}
                  </button>
                  <button 
                    onClick={() => setActiveModal(null)}
              ...
              <div className="p-5 space-y-4 text-center">
                  ...
                  <div className="relative bg-[#050B14] p-5 rounded-2xl border border-white/5 overflow-hidden">
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="relative">
                        <p className="text-gray-500 text-[9px] uppercase tracking-widest mb-1.5 opacity-70">Room ID</p>
                      ...
                      {/* Password Section */}
                      <div className="relative">
                        <p className="text-gray-500 text-[9px] uppercase tracking-widest mb-1.5 opacity-70">Room Pass</p>
                        <div className="flex items-center justify-center gap-3">
                ...
                <div className="flex items-center justify-center gap-2 text-[9px] text-gray-500 bg-white/5 py-2.5 px-3 rounded-xl border border-white/5">
                  ...
                  <p className="tracking-wide">Updated 10 min before match start</p>
                </div>
