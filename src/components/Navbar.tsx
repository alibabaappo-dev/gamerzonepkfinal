        ...
        <div className="container mx-auto px-6 h-20 flex justify-between items-center">
            <div className="relative flex items-center flex-1 overflow-hidden mr-8">
              ...
              <div className="relative flex-1 overflow-hidden flex items-center">
                <button 
                  onClick={() => scroll('left')}
                  className="absolute left-0 z-10 bg-gradient-to-r from-[#0D0D0F] via-[#0D0D0F] to-transparent p-2 text-gray-400 hover:text-white transition-all mr-8"
                >
                  <ChevronLeft size={20} />
                </button>
          ...
          <div className="flex items-center space-x-6">
            <Link to="/wallet" className="flex items-center gap-2 bg-[#1C1C1E] px-4 py-2 rounded-full border border-gray-800 hover:border-yellow-500/50 transition-all">
              <img src="https://i.ibb.co/4wV6Jtr6/coins-2.png" alt="Coins" className="w-5 h-5" />
      ...
      <header className="lg:hidden bg-[#1C1C1E] sticky top-0 z-40 border-b border-gray-700/50">
        <div className="container mx-auto px-4 h-16 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/wallet" className="flex items-center gap-1 bg-[#1C1C1E] px-3 py-2 rounded-full border border-gray-700">
              <img src="https://i.ibb.co/4wV6Jtr6/coins-2.png" alt="Coins" className="w-4 h-4" />
